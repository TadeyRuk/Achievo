...
export function BottomNav({ activeTab, onTabChange }: BottomNavProps) {
  ...
  return (
    <div
      className="absolute bottom-4 left-4 right-4 bg-[var(--dah-surface)] border border-[var(--dah-outline-variant)] rounded-[28px] z-50 shadow-lg shadow-black/10"
      style={{ paddingBottom: "env(safe-area-inset-bottom)" }}
    >
      <div className="flex items-center justify-around h-20 sm:h-24 px-2">
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className="flex-1 flex flex-col items-center gap-1.5 py-1 relative transition-all"
            >
